  ...
  collections: {
    ...
    novel_chapters: collection({
      ...
      schema: {
        ...
        part: fields.object({
          number: fields.integer({ label: "部序號 (數字，如 1 代表第一部)", defaultValue: 1 }),
          title: fields.text({ label: "部名稱 (如：第一部 天命初顯)", defaultValue: "第一部 天命初顯" }),
        }, { label: "部 (Part) 階層設定" }),
        volume: fields.object({
          number: fields.integer({ label: "卷序號 (數字，如 1 代表第一卷)", defaultValue: 1 }),
          title: fields.text({ label: "卷名稱 (如：第一卷 風起青萍)", defaultValue: "第一卷 風起青萍" }),
        }, { label: "卷 (Volume) 階層設定" }),
        chapter: fields.object({
          number: fields.integer({ label: "章序號 (數字，如 1 代表第一章)", defaultValue: 1 }),
          title: fields.text({ label: "章名稱 (如：第一章 孤崖夜雨)", defaultValue: "第一章 孤崖夜雨" }),
        }, { label: "章 (Chapter) 階層設定" }),
        section: fields.object({
          number: fields.integer({ label: "節序號 (數字，如 1 代表第一節)", defaultValue: 1 }),
          title: fields.text({ label: "節名稱 (如：第一節 破廟殘燈)", defaultValue: "第一節 破廟殘燈" }),
        }, { label: "節 (Section) 階層設定" }),
